 ...
 * File Name:             vang_Lab4_implementation_v001.c
 * File Description:      Consists of function methods to implement code in
 *                        vang_Lab4_main_v001.c file. 
 */
 ...
 *                  RB7 to input. It then utilizes PPS to bind OC1 to RB6/RP6 
 *                  and initializes Timer 3 to have a period of 2ms. It also
 *                  sets OC1 peripheral to the proper values.
 * Pre-condition:   None
...
void initServo(void){
    ...
    TRISB = 0b0000000010000011;     // Set port B RB6 to output (LOW) and RB7 to
                                    // input (HIGH)
    __builtin_write_OSCCONL(OSCCON & 0xBF);   // Unlock PPS
    //RPINR7bits.IC1R = 7;            // Use PIN RP7 = "7", for Input Capture 1
